...
import 'package:health_dash/home_page.dart';
          ...
          Card(elevation:50,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("1.Quick-appointment✔",style:TextStyle(
                    fontSize: 13,
          ...
          Card(elevation: 50,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("2.Full Healthcheck ✔",style:TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.bold,
                    color: Colors.black), ),
              ],
          ...
          Card(elevation: 50,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("3.Proper consultation ✔",style:TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.bold,
                    color: Colors.black), ),
              ],
          ...
          Card(elevation: 50,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("4.Safety first✔",style:TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.bold,
                    color: Colors.black), ),
              ],
