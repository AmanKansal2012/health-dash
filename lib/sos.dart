...
class _SOSState extends State<SOS> {
  ...
  Widget build(BuildContext context) {
    ...
    Container(
    height:40,width: 40,
    child: Image.network("https://banner2.cleanpng.com/20180424/gsq/kisspng-helpline-mental-health-information-technical-suppo-new-year-wish-5adfa7e4c69d76.3451582015246069488135.jpg")),
    Text("SOS helpline"),
    ],
    ),),
    ),
    ...
    Container(
    height:40,width: 40,
    child: Image.network("https://pngtree.com/freepng/q-version-cute-saluting-police-cartoon-design_4377239.html")),
    Text("Police"),
    ],
    ),),
    ),
